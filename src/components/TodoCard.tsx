  ...
  return (
    <div className="relative w-full">
      <div
        ...
        } relative rounded-lg border-2 border-gray-500 bg-opacity-40 shadow-md motion-safe:hover:scale-[1.01]`}
      >
        <div
        ...
        <div className="group flex w-full items-center justify-between">
          ...
          >
            ...
            <div className="btn-circle flex items-center justify-center border !opacity-100 shadow-md shadow-gray-700/5">
              {todo.isComplete && (
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
